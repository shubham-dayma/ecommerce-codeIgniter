                        ...
                        <div class="row">
                            <div class="col-sm-12" style="padding: 50px;">
                                ...
                                <div class="col-sm-6" align="right">
                                    <h3></h3>
                                    <img src="<?= base_url('attachments/shop_images/' . $article['image']) ?>" style="max-height: 280px">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="item <?= $i == 0 ? 'active' : '' ?>">
                                <div class="col-xs-12 col-sm-4">
                                    <a href="<?= LANG_URL . '/' . $product['url'] ?>">
                                        ...
                                        <h1><?= character_limiter($product['title'],50) ?></h1>
...
<div class="blog-posts new-products">
    <div class="container">
