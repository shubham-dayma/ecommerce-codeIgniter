                ...
                <div class="col-lg-3  col-md-3 col-sm-4 col-xs-6 f-col">
                    ...
                    <ul class="footer-icon">
                        <?php if ($footerContactAddr != '') { ?>
                            <li>
                                <span><i class="fa fa-map-marker"></i> <?= $footerContactAddr ?></span> 
                            </li>
                        <?php }if ($footerContactPhone != '') { ?>
                            <li>
                                <span><i class="fa fa-phone"></i> <?= $footerContactPhone ?></span> 
                            </li>
                            ...
                            <div class="input-append newsletter-box text-center">
                                <form method="POST" id="subscribeForm">
                                    <div style="display: flex;">
                                        ...
                                        <button class="btn bg-green" onclick="checkEmailField()" type="button"> <?= lang('subscribe') ?> <i class="fa fa-long-arrow-right"></i></button>
                                    </div>
                                </form>
                            </div>
                        </li>
