...
<html lang="<?= MY_LANGUAGE_ABBR ?>">
    <head>
        <?php $title = !empty($title) ? $title : 'Stratfor Shopy' ?>
        <meta charset="utf-8" />
        ...
        <meta property="og:image" content="<?= !empty($image) ? $image : base_url('assets/img/site-overview.png') ?>" />
        <title><?= $title ?></title>
        ...
        <link rel="icon" href="<?= base_url('attachments/site_logo/' . $sitelogo) ?>" type="image/gif" sizes="16x16">
    ...
    <body>
        <div class="container">
            ...
            <div class="row header">
                ...
                <div class="col-md-4 col-xs-12" style="top: 35px">
                    <form method="GET" class="search" id="bigger-search" action="<?= LANG_URL . '/shop' ?>">
                            ...
                            <input type="text" class="form-control" id="search_in_title" value="<?= isset($_GET['search_in_title']) ? htmlspecialchars($_GET['search_in_title']) : '' ?>" placeholder="<?= lang('search_here') ?>">
                            <a href="javascript:void(0);" onclick="submitForm()"><i class="fa fa-search"></i></a>
                    </form>
                </div>    
                <div class="col-md-6 col-sm-10 col-xs-10" style="top: 35px">
