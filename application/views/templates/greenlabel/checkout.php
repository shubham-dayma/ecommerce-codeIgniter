                ...
                <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-products">
                            <thead>
                                <tr>
                                    <th><?= character_limiter(lang('product'),200) ?></th>
                                    <th><?= lang('title') ?></th>
                                    <th width="18%"><?= lang('quantity') ?></th>
                                    <th><?= lang('price') ?></th>
                                    <th><?= lang('total') ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($cartItems['array'] as $item) { ?>
                                    <tr>
                                        ...
                                        <td><?= format_price($item['sum_price']) ?></td>
                                    </tr>
                                <?php } ?>
                                <tr>
                                    <td colspan="4" class="text-right"><?= lang('total') ?></td>
                                    <td>
                                        <span class="final-amount"><?= format_price($cartItems['finalSum']) ?></span>
