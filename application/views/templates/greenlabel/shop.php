    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group">
                <select class="selectpicker order form-control" data-style="btn-green" data-order-to="order_price" title="<?= lang('price_title') ?>..">
                    <option label="<?= lang('not_selected') ?>"><?= lang('relevance') ?></option>
            ...
            <div class="categories">
                <div class="title">
                    ...
                    <?php if (isset($_GET['category']) && $_GET['category'] != '') { ?>
                        <a href="javascript:void(0);" class="clear-filter" data-type-clear="category" data-toggle="tooltip" data-placement="left" title="<?= lang('clear_the_filter') ?>" style="float: right;color: #ffff"><i class="fa fa-times" aria-hidden="true"></i></a>
                    <?php } ?>
                </div>
                <div class="body">
                            ...
                            <ul class="<?= $is_recursion === true ? 'children' : 'parent' ?>">
                                ...
                                foreach ($pages as $page) {
                                    ...
                                    <li>
                                        ...
                                        <?php } else { ?>
                                            <i class="fa fa-circle-o <?= isset($_GET['category']) && $_GET['category'] == $page['id'] ? 'selected' : '' ?>" aria-hidden="true"></i>
                                        <?php } ?>
                ...
                <div class="filter-sidebar">
                    <div class="title">
                        ...
                        <?php if (isset($_GET['brand_id']) && $_GET['brand_id'] != '') { ?>
                            <a href="javascript:void(0);" class="clear-filter" data-type-clear="brand_id" data-toggle="tooltip" data-placement="left" title="<?= lang('clear_the_filter') ?>" style="float: right;color: #ffff"><i class="fa fa-times" aria-hidden="true"></i></a>
                        <?php } ?>
                    </div>
                    <ul>
                ...
                <div class="filter-sidebar">
                    <div class="title">
                        ...
                        <?php if (isset($_GET['in_stock']) && $_GET['in_stock'] != '') { ?>
                            <a href="javascript:void(0);" class="clear-filter" data-type-clear="in_stock" data-toggle="tooltip" data-placement="left" title="<?= lang('clear_the_filter') ?>" style="float: right;color: #ffff"><i class="fa fa-times" aria-hidden="true"></i></a>
                        <?php } ?>
                    </div>
                    <ul>
                        <li>
        ...
        <div class="col-md-9 eqHeight" id="products-side">
            ...
            if (!empty($products)) {
                ...
                ?>
                    ...
                    <div class="col-sm-6 col-md-4 product-inner">
                        ...
                        <div class="bottom-content">
                            <h3><?= character_limiter($product['title'],50) ?></h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p style="text-align: center;padding: 30px;"><?= lang('no_results') ?></p>
                    </div>
                </div>    
                <!-- <script>
