                            ...
                            while (($file = readdir($dh)) !== false) {
                                if (is_file($dir . $file)) {
                                    ...
                                    <div class="col-xs-3 col-sm-4 col-md-3 text-center">
                                        <img src="<?= base_url($dir . $file) ?>" data-num="<?= $i ?>" class="other-img-preview img-sl img-thumbnail the-image" alt="<?= str_replace('"', "'", $product['title']) ?>" style="height: 70px">
                                    </div>
                                    <?php
                                    $i++;
                                }
        ...
        <div class="col-sm-8">
            <div class="product-info">
                ...
                <div class="row row-info">
                    ...
                    <div class="col-sm-6"><?= format_price($product['price']) ?></div>
                    <div class="col-sm-12 border-bottom"></div>
                </div>
                <?php if ($product['old_price'] != '') { ?>
                    <!-- <div class="row row-info">
                        <div class="col-sm-6"><b><?= lang('old_price') ?>:</b></div>
                        <div class="col-sm-6"><?= format_price($product['old_price']) ?></div>
                        <div class="col-sm-12 border-bottom"></div>
                    </div> -->
            ...
            ?>
                ...
                <div class="col-sm-6 col-md-4 product-inner">
                    ...
                    <div class="bottom-content">
                        <h3><?= character_limiter($prod['title'],50) ?></h3>
                        <span class="price"><?= format_price($prod['price']) ?></span>
